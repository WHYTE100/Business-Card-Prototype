...
public class AddBusinessLogoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_business_logo);
        ...
        addBtn.setOnClickListener(v -> requestStoragePermission());
                ...
                .withErrorListener(
                        new PermissionRequestErrorListener() {
                            ...
                            public void onError(DexterError error) {
                                Toast.makeText(AddBusinessLogoActivity.this.getApplicationContext(), "Error occurred! ", Toast.LENGTH_SHORT)
                                        .show();
                            }
                        })
                .onSameThread()
    ...
    private void showSettingsDialog() {
        ...
        builder.setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                AddBusinessLogoActivity.this.openSettings();
            }
        });
        ...
        filepath.putFile(resultUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                db.collection("Businesses").document(BusinessKey)
                        .set(businessMap, SetOptions.merge());
                ...
                CompanyRef.child(BusinessKey).updateChildren(businessMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            Intent intent = new Intent(AddBusinessLogoActivity.this, BusinessAccountActivity.class);
                            intent.putExtra("key",BusinessKey);
                            startActivity(intent);
                            finish();
                            Animatoo.animateFade(AddBusinessLogoActivity.this);

                        }else {
                            progressBar.setVisibility(ProgressBar.INVISIBLE);
                            Toast.makeText(AddBusinessLogoActivity.this, "Failed to Save Photo. Try Again!!", Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
    ...
    public void skipLogoAdding(View view) {
        Intent intent = new Intent(AddBusinessLogoActivity.this, BusinessAccountActivity.class);
        intent.putExtra("key",BusinessKey);
        startActivity(intent);
        finish();
