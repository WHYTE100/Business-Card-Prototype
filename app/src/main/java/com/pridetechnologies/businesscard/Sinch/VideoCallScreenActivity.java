...
public class VideoCallScreenActivity extends BaseActivity {
    ...
    ImageView endCallButton, flipCameraButton, muteButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flipCameraButton=findViewById(R.id.changeCameraButton);
    ...
    public void muteCall(View view) {
        ...
        Toast.makeText(VideoCallScreenActivity.this, "audio muted", Toast.LENGTH_LONG).show();
    }
