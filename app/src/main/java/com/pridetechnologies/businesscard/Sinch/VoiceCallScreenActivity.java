...
public class VoiceCallScreenActivity extends BaseActivity {
    ...
    Intent intent;
    private CircleImageView profileImageCalling;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileImageCalling = (CircleImageView) findViewById(R.id.profile_image_calling);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (dataSnapshot.hasChild("user_first_name")){
                        receiverUserName=dataSnapshot.child("user_first_name").getValue().toString();
                        String userSurName=dataSnapshot.child("user_surname").getValue().toString();
                        mCallerName.setText(receiverUserName+" "+userSurName);
                    }
                    if (dataSnapshot.hasChild("user_image")){
                        receiverUserImage=dataSnapshot.child("user_image").getValue().toString();
    ...
    public void onPause() {
        super.onPause();
        //mCallState.setText("Call Paused");
