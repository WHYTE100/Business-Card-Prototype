...
import static com.pridetechnologies.businesscard.models.Constants.SKU_DELAROY_MONTHLY;
import static com.pridetechnologies.businesscard.models.Constants.SKU_DELAROY_SIXMONTH;
import static com.pridetechnologies.businesscard.models.Constants.SKU_DELAROY_YEARLY;
import static com.pridetechnologies.businesscard.models.Constants.base64EncodedPublicKey;
...
import com.pridetechnologies.businesscard.util.IabBroadcastReceiver;
import com.pridetechnologies.businesscard.util.IabHelper;
import com.pridetechnologies.businesscard.util.IabResult;
import com.pridetechnologies.businesscard.util.Inventory;
import com.pridetechnologies.businesscard.util.Purchase;

import java.util.ArrayList;
import java.util.List;

public class BraintreePaymentActivity extends AppCompatActivity implements IabBroadcastReceiver.IabBroadcastListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            public void onIabSetupFinished(IabResult result) {
                ...
                mBroadcastReceiver = new IabBroadcastReceiver(BraintreePaymentActivity.this);
    ...
    public void updateUi() {
        ...
        if (mSubscribedToDelaroy) {
            ...
            subscribeButton.setImageResource(R.drawable.ic_baseline_add_black_40);
        }
