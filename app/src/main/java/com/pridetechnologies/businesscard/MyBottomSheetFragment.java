...
public class MyBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    private DatabaseReference CompanyRef, CompanyTeamRef, usersRef, MyCardsRef, CardRequestRef;
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        //Set the custom view
        View view = LayoutInflater.from(getContext()).inflate(R.layout.business_info_bottom_sheet, null);
        ...
        adapter =
                new FirebaseRecyclerAdapter<TeamCard, BusinessTeamViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull final BusinessTeamViewHolder cardViewHolder, final int i, @NonNull final TeamCard card)
                    {
                        ...
                        MyCardsRef.child(currentUserID).child(TeamMemberID).addValueEventListener(new ValueEventListener() {
                            @Override
                            ...
                            public void onDataChange(@NonNull final DataSnapshot snapshot) {
                                if (snapshot.exists())
                                {
                                    ...
                                    if ((snapshot.hasChild("user_first_name")))
                                    {
                                        ...
                                        cardViewHolder.user_name.setText(Title+" "+FirstName+" "+OtherNames+" "+Surname);
